...
#+begin_src emacs-lisp
(add-hook 'prog-mode-hook #'(lambda () (unless (bound-and-true-p lsp-mode)
...
#+begin_src emacs-lisp
(use-package icomplete-vertical	; TODO : emacs 28 terá icomplete-vertical por padrão (pacote diferente)
  :demand t
  :custom
...
(use-package lispy
  :hook
  ((scheme-mode emacs-lisp-mode lisp-mode) . lispy-mode))
